...
<%--   <c:choose> 
  ...
  <tr   id="tr_btn_modify"  align="center"  >
	   <td colspan="2"   >
	       <input type=button value="commit update"   onClick="fn_modify_article(frmArticle)"  >
  ...
  <tr  id="tr_btn"    >
   <td colspan="2" align="center">
       <c:if test="${member.id == article.id }">
	    ...
	    <%-- <input type=button value="write reply"  onClick="fn_reply_form('${contextPath}/board/replyForm.do', ${article.articleNO})"> --%>
   </td>
  </tr>
 </table>
 </form>
